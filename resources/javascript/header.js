...
function headerchange(check)
{
	if(check==1)
	{
		...
		var img=document.getElementById('rout-home').src="../images/home-hover.png";
	}
	else if(check==2)
	{
...
function headerorigin(check)
{
	if(check==1)
	{
		...
		var img=document.getElementById('rout-home').src="../images/home.png";
	}
	else if(check==2)
	{
...
function changelogo(connectID)
{
  ...
  setTimeout(function(){
	  ...
	  var noofconnections=document.getElementById("noconnections");
	  var place=parseInt(noofconnections.innerHTML)+1;
	  noofconnections.innerHTML=place;}, 3000);
